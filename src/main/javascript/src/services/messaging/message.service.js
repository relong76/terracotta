 ...
 */
async function copy(experiment_id, exposure_id, group_id, message_id, from_message_dto) {
  const requestOptions = {
    method: "POST",
    headers: { ...authHeader(), "Content-Type": "application/json" },
    body: JSON.stringify(
  ...
  return fetch(`${store.getters["api/aud"]}/api/experiments/${experiment_id}/exposures/${exposure_id}/messaging/group/${group_id}/message/${message_id}/copy`, requestOptions).then(handleResponse);
}
