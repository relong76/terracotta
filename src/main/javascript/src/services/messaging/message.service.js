...
async function update(experiment_id, exposure_id, group_id, message_id, payload) {
  ...
  return fetch(`${store.getters["api/aud"]}/api/experiments/${experiment_id}/exposures/${exposure_id}/messaging/group/${group_id}/message/`, requestOptions).then(handleResponse);
}
