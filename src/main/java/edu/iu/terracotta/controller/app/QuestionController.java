...
public class QuestionController {
    ...
    public ResponseEntity<QuestionDto> postQuestion(@PathVariable long experimentId,
                                                    ...
                                                    HttpServletRequest req)
            throws ExperimentNotMatchingException, AssessmentNotMatchingException, BadTokenException, IdInPostException, DataServiceException, MultipleChoiceLimitReachedException, IntegrationNotFoundException {
