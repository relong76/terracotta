...
public interface MessageContentAttachmentService {
    ...
    MessageContentAttachmentDto delete(Message message, UUID contentUuid, UUID uuid, SecuredInfo securedInfo) throws MessageContentNotFoundException, MessageContentNotMatchingException, MessageContentAttachmentException, CanvasApiException, IOException, MessageContentAttachmentNotMatchingException;
    MessageContentAttachmentDto delete(MessageContentAttachment messageContentAttachment, LtiUserEntity ltiUserEntity) throws CanvasApiException;
    MessageContentAttachment duplicate(MessageContentAttachment messageContentAttachment, MessageContent messageContent);
