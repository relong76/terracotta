...
public interface MessageConfigurationService {
    ...
    MessageConfiguration duplicate(MessageConfiguration messageConfiguration);
    MessageConfiguration copy(MessageConfiguration fromConfiguration, MessageConfiguration toConfiguration);
