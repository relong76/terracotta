...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public QuestionDto postQuestion(QuestionDto questionDto, long assessmentId, boolean answers, boolean isNew) throws IdInPostException, DataServiceException, MultipleChoiceLimitReachedException, IntegrationNotFoundException {
        ...
        try {
            ...
            switch (question.getQuestionType()) {
                ...
                case INTEGRATION:
                    if (isNew) {
                        question.setIntegration(integrationService.create(question));
                        break;
                    }
