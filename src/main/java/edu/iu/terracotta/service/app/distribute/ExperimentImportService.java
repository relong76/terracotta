...
public interface ExperimentImportService {
     ...
     * repointTargets, notifyOwnerOnLmsFailure: see ExperimentImportAsyncService.process.
     ...
     */
    ImportDto preprocessFromFile(File file, String originalFilename, SecuredInfo securedInfo, LmsRepointTargets repointTargets, boolean notifyOwnerOnLmsFailure) throws ExperimentImportException;
