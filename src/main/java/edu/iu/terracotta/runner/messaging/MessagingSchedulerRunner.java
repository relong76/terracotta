...
public class MessagingSchedulerRunner {
    ...
    public static final TaskWithoutDataDescriptor MESSAGING_SEND_TASK = new TaskWithoutDataDescriptor(TASK_NAME);
    ...
    Task<Void> messagingSchedulerSendTask(MessagingSchedulerService messagingSchedulerService) {
        ...
        return Tasks.recurring(MESSAGING_SEND_TASK, Schedules.fixedDelay(Duration.ofSeconds(interval * 60)))
