...
public class QuestionControllerTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
        ...
        questionController = new QuestionController(questionService, apiJwtService, experimentService);
    ...
    void getQuestionsByAssessmentTest() throws Exception {
        ...
        ResponseEntity<List<QuestionDto>> response = questionController.getQuestionsByAssessment(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, httpServletRequest);
    ...
    void getQuestionsByAssessmentThrowsTest() throws Exception {
        ...
        assertThrows(ExperimentNotMatchingException.class, () -> questionController.getQuestionsByAssessment(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, httpServletRequest));
    }
    ...
    void getQuestionTest() throws Exception {
        ...
        ResponseEntity<QuestionDto> response = questionController.getQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, QUESTION_ID, false, httpServletRequest);
    ...
    void getQuestionThrowsTest() throws Exception {
        ...
        assertThrows(QuestionNotMatchingException.class, () -> questionController.getQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, QUESTION_ID, false, httpServletRequest));
    }
    ...
    void postQuestionTest() throws Exception {
        ...
        ResponseEntity<QuestionDto> response = questionController.postQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, false, questionDto, UriComponentsBuilder.newInstance(), httpServletRequest);
    ...
    void postQuestionThrowsTest() throws Exception {
        ...
        assertThrows(MultipleChoiceLimitReachedException.class, () -> questionController.postQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, false, questionDto, UriComponentsBuilder.newInstance(), httpServletRequest));
    }
    ...
    void updateQuestionsTest() throws Exception {
        ...
        ResponseEntity<Void> response = questionController.updateQuestions(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, List.of(questionDto), httpServletRequest);
    ...
    void updateQuestionsThrowsTest() throws Exception {
        ...
        assertThrows(DataServiceException.class, () -> questionController.updateQuestions(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, List.of(questionDto), httpServletRequest));
    }
    ...
    void updateQuestionTest() throws Exception {
        ...
        ResponseEntity<Void> response = questionController.updateQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, QUESTION_ID, questionDto, httpServletRequest);
    ...
    void updateQuestionThrowsTest() throws Exception {
        ...
        assertThrows(NegativePointsException.class, () -> questionController.updateQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, QUESTION_ID, questionDto, httpServletRequest));
    }
    ...
    void deleteQuestionTest() throws Exception {
        ...
        ResponseEntity<Void> response = questionController.deleteQuestion(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, QUESTION_ID, httpServletRequest);
    ...
    void deleteQuestionsTest() throws Exception {
        ...
        ResponseEntity<Void> response = questionController.deleteQuestions(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, List.of(questionDto), httpServletRequest);
    ...
    void deleteQuestionsThrowsTest() throws Exception {
        ...
        assertThrows(QuestionNotMatchingException.class, () -> questionController.deleteQuestions(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, List.of(questionDto), httpServletRequest));
    }
    ...
    void deleteQuestionsPropagatesEmptyResultTest() throws Exception {
        ...
        assertThrows(EmptyResultDataAccessException.class, () -> questionController.deleteQuestions(EXPERIMENT_UUID, CONDITION_ID, TREATMENT_ID, ASSESSMENT_ID, List.of(questionDto), httpServletRequest));
    }
