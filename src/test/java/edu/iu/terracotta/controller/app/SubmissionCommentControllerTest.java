...
public class SubmissionCommentControllerTest extends BaseTest {
    ...
    void getSubmissionCommentsBySubmissionTest() throws Exception {
        ...
        ResponseEntity<List<SubmissionCommentDto>> ret = submissionCommentController.getSubmissionCommentsBySubmission(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, httpServletRequest);
    ...
    void getSubmissionCommentsBySubmissionInvalidUserTest() throws Exception {
        ...
        assertThrows(InvalidUserException.class, () -> submissionCommentController.getSubmissionCommentsBySubmission(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, httpServletRequest));
    }
    ...
    void getSubmissionCommentsBySubmissionExperimentNotMatchingTest() throws Exception {
        ...
        assertThrows(ExperimentNotMatchingException.class, () -> submissionCommentController.getSubmissionCommentsBySubmission(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, httpServletRequest));
    }
    ...
    void getSubmissionCommentTest() throws Exception {
        ...
        ResponseEntity<SubmissionCommentDto> ret = submissionCommentController.getSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, httpServletRequest);
    ...
    void getSubmissionCommentNotMatchingTest() throws Exception {
        ...
        assertThrows(SubmissionCommentNotMatchingException.class, () -> submissionCommentController.getSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, httpServletRequest));
    }
    ...
    void postSubmissionCommentTest() throws Exception {
        ...
        ResponseEntity<SubmissionCommentDto> ret = submissionCommentController.postSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, submissionCommentDto, UriComponentsBuilder.newInstance(), httpServletRequest);
    ...
    void postSubmissionCommentStudentValidatesUserTest() throws Exception {
        ...
        submissionCommentController.postSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, submissionCommentDto, UriComponentsBuilder.newInstance(), httpServletRequest);
    ...
    void postSubmissionCommentIdInPostTest() throws Exception {
        ...
        assertThrows(IdInPostException.class, () -> submissionCommentController.postSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, submissionCommentDto, UriComponentsBuilder.newInstance(), httpServletRequest));
    }
    ...
    void postSubmissionCommentAssessmentNotMatchingTest() throws Exception {
        ...
        assertThrows(AssessmentNotMatchingException.class, () -> submissionCommentController.postSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, submissionCommentDto, UriComponentsBuilder.newInstance(), httpServletRequest));
    }
    ...
    void updateSubmissionCommentTest() throws Exception {
        ...
        ResponseEntity<Void> ret = submissionCommentController.updateSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, submissionCommentDto, httpServletRequest);
    ...
    void updateSubmissionCommentNotMatchingTest() throws Exception {
        ...
        assertThrows(SubmissionCommentNotMatchingException.class, () -> submissionCommentController.updateSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, submissionCommentDto, httpServletRequest));
    }

    @Test
    void deleteSubmissionCommentTest() throws Exception {
        ResponseEntity<Void> ret = submissionCommentController.deleteSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, httpServletRequest);
    ...
    void deleteSubmissionCommentAssessmentNotMatchingTest() throws Exception {
        ...
        assertThrows(AssessmentNotMatchingException.class, () -> submissionCommentController.deleteSubmissionComment(EXPERIMENT_UUID, CONDITION_UUID, TREATMENT_UUID, ASSESSMENT_UUID, 1L, 1L, httpServletRequest));
    }
