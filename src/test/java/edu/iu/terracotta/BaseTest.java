...
public class BaseTest {
    ...
    @Mock protected CanvasAPITokenScopeRepository canvasAPITokenScopeRepository;
    ...
    @Mock protected CanvasAPITokenScopeService canvasAPITokenScopeService;
    ...
    @Mock protected CanvasAPITokenScope canvasAPITokenScope;
    ...
    public void setup() {
        try {
            ...
            when(canvasAPITokenScopeRepository.findAll()).thenReturn(Collections.singletonList(canvasAPITokenScope));
            when(canvasAPITokenScopeRepository.findAllByCanvasAPIScope_Id(anyLong())).thenReturn(Collections.singletonList(canvasAPITokenScope));
            when(canvasAPITokenScopeRepository.findAllByCanvasAPITokenEntity_TokenId(anyLong())).thenReturn(Collections.singletonList(canvasAPITokenScope));
            ...
            when(canvasAPITokenScopeService.createTokenScopes(anyList())).thenReturn(Collections.singletonList(canvasAPITokenScope));
            when(canvasAPITokenScopeService.getAllTokenScopes()).thenReturn(Collections.singletonList(canvasAPITokenScope));
            when(canvasAPITokenScopeService.getScopesForTokenId(anyLong())).thenReturn(Collections.singletonList(canvasAPITokenScope));
            when(canvasAPITokenScopeService.getTokensForScopeId(anyLong())).thenReturn(Collections.singletonList(canvasAPITokenScope));
            ...
            when(canvasAPITokenScope.getCanvasAPIScope()).thenReturn(canvasAPIScope);
            when(canvasAPITokenScope.getCanvasAPITokenEntity()).thenReturn(canvasAPITokenEntity);
